...
void main() {
  runApp(WealthAstrologyConsultation());
}

class WealthAstrologyConsultation extends StatelessWidget {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 32),
              Text('Wealth Consultation For Areas -- ',
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              SizedBox(height: 16),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
                  FeelingItem(label: 'Investments', emoji: '📈'),
                  FeelingItem(label: 'Savings', emoji: '💰'),
                  FeelingItem(label: 'Debts', emoji: '💸'),
                  FeelingItem(label: 'Retirement', emoji: '🏖️'),
                ],
              ),
              SizedBox(height: 32),
              Text('Services',
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              SizedBox(height: 16),
              ServiceItem(name: 'Wealth Horoscope', price: 500),
              ServiceItem(name: 'Wealth Predictions', price: 700),
              ServiceItem(name: 'Financial Healing', price: 1000),
              ServiceItem(name: 'Astrological Investment Advice', price: 1200),
              ServiceItem(name: 'Wealth Rituals', price: 1500),
              ServiceItem(name: 'Lunar Wealth Insights', price: 1800),
              ServiceItem(name: 'Astrological Remedies', price: 2000),
              ServiceItem(
                  name: 'Personalized Wealth Consultation', price: 3000),
...
class ServiceItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: ListTile(
        leading: Image.asset('assets/images/WealthConsultation.PNG',
