...
class _RelationshipState extends State<Relationship> {
  final List<String> imagePaths = [
    ...
    'assets/images/relationshiphealing.jpg',
    'assets/images/cordcutting.jpg',
    'assets/images/mangaldosh.jpg',
    'assets/images/vivahbadha.jpg', 
  ];
            ...
            children: [
              Align(
                ...
                child: Container(
                  ...
                  child: Image.asset('assets/images/relationlnding.png'),
                ),
              ),
              SafeArea(
                child: Container(
