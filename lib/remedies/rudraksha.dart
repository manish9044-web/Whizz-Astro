...
class Rudraksha extends StatefulWidget {
  const Rudraksha({super.key});

  @override
  State<Rudraksha> createState() => _RudrakshaState();
}

class _RudrakshaState extends State<Rudraksha> {
            ...
            children: [
              Align(
                ...
                child: Container(
                  ...
                  child: Image.asset('assets/images/spelllanding.png'),
                ),
              ),
              SafeArea(
                child: Container(
