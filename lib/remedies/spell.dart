...
class Spell extends StatefulWidget {
  const Spell({super.key});

  @override
  State<Spell> createState() => _SpellState();
}

class _SpellState extends State<Spell> {
  final List<String> imagePaths = [
    'assets/images/lovecandle.jpeg',
    'assets/images/spell 2.png',
    'assets/images/spell.jpg',
    'assets/images/spell 6.jpg',
    'assets/images/spell 1.png',  
  ];
