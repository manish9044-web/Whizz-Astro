              ...
              Row(
                children: [
                  const CircleAvatar(
                    radius: 40,
                    backgroundImage:
                        AssetImage('assets/images/Monia.PNG'),
                  ),
                  const SizedBox(width: 10),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Monia Singh',
                          style: TextStyle(
                              fontSize: 20, fontWeight: FontWeight.bold)),
                      const SizedBox(height: 8.0),
                      const Text('Vastu consultant, Tarot Card'),
...
class ReviewCard extends StatelessWidget {
  ...
  ReviewCard({required this.name, required this.review, required this.image});
...
class ReportRow extends StatelessWidget {
  ...
  ReportRow({required this.title, this.priceRange, this.price});
